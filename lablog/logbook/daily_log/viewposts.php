...
#Associate databases w/ logbook title for printing
$logbook_titles = array(
    "posts_analysis" => "EXO-200/nEXO Analysis & Simulations Logbook",
    "posts_darkside" => "Darkside Logbook",
    "posts_lxe" => "Liquid Xenon System Logbook",
    "posts_misc" => "Miscellaneous Logbook",
    "posts_photosensor" => "Photosensor Test Bench Logbook",
